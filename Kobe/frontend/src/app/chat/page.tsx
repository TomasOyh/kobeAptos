...
export default function Chat() {
  ...
  const handleDeploy = async (network: 'avax' | 'zkEVM'|'solana'|'aptos') => {
    setIsDeploying(true);
  ...
  return (
    <div className={`flex h-screen overflow-hidden ${isDarkTheme ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-800'}`}>
      {/* Sidebar */}
      <div className={`w-64 flex-shrink-0 ${isDarkTheme ? 'bg-gray-800' : 'bg-white'} flex flex-col shadow-lg`}>
